    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center">
      ...
      <div className="flex items-start space-x-16">
        ...
        <div className="bg-white shadow-xl rounded-lg p-8 w-96">
          <h2 className="text-2xl font-medium mb-6 text-center text-gray-700">Create Agent</h2>
        ...
        {isModalVisible && (
          <div className="ml-8 bg-white shadow-xl rounded-lg p-6 w-80">
            <h3 className="text-lg font-semibold mb-4 text-center text-gray-700">Agent Details</h3>
            <div className="mb-4">
              <h4 className="text-sm font-medium text-gray-600">Generated Password:</h4>
