  ...
  >
    Create Agent(s)
      ...
      <div className="w-full flex justify-center items-start space-x-6 transition-all duration-300">
            ...
            <>
              <div className="flex items-center p-6">
                <div className="flex-1">
                  <h2 className="text-2xl font-medium text-gray-800 mb-2">{data[0].name}</h2>
              ...
              <div className="p-4 grid grid-cols-1 gap-4">
                ...
                {menus.map((menu, index) => (
                  ...
                  >
                    <p className="text-gray-800 font-normal">{menu.menu_type}</p>
                    <button
        ...
        {selectedMenu && (
          <div className="w-1/2 bg-white shadow-lg p-6 rounded-lg self-center"> {/* Adjusted for centering and width */}
            <button
            ...
            <h2 className="text-xl font-light mb-4">Categories for {selectedMenu}</h2>
            <CategoryList data={{ categories: getCategoriesForMenu(selectedMenu)}} menus={menus} selectedMenu={selectedMenu} loc_id={loc_id} />
          </div>
        )}
      </div>
    </div>
