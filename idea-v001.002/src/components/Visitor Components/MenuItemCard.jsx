...
const MenuItemCard = ({ item, handleAddToCart, handleRemoveFromCart, cartItems }) => {
  return (
    <div className="flex items-center p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 mb-4">
      ...
      <div className="flex items-center ml-3">
        ...
        <span className="mx-2 text-gray-900 font-semibold">{cartItems[item.id]?.quantity || 0}</span>
        <button
