...
const MenuItemCard = ({
  ...
  return (
    <>
      <div
        className="flexbox items-center p-2 menu-item"
      ...
      {showDetail && (
        <div className="modal-overlay">
          <div className="modal-content">
            <MenuDetail menu_id={item.menu_id} loc_id={loc_id} handleRemoveFromCart={handleRemoveFromCart} handleAddToCart={handleAddToCart} cartItems={cartItems} handleCloseModal={()=>setShowDetail(false)} />
            <button
